...
function NewNotificationofSensor {
    ...
    formatSensorNotificationNew -Authtoken $Authtoken -notiID $noti.nid -sensorid $noti.parent_id  -DeferId $deferid
}
...
function NewNotificationofContainer {
    ...
    formatContainerNotificationNew -notiID $noti.nid -authoken $Authtoken -SensorhubID $noti.parent_id -deferid $deferId
