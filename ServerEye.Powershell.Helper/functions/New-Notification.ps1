...
function NewNotificationofSensor {
    ...
    formatSensorNotificationNew -Authtoken $Authtoken -notiID $noti.id -sensorid $noti.parent_id  -DeferId $deferid
}
...
function NewNotificationofContainer {
    ...
    formatContainerNotificationNew -notiID $noti.id -authoken $Authtoken -SensorhubID $noti.parent_id -deferid $deferId
