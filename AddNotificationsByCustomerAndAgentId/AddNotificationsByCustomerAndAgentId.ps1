<# AddNotificationsByCustomerAndAgentId
AUTOR: Mike Semlitsch
DATE: 24.02.2016
VERSION: V1.0
DESC: Adds a notification to all agents of the specified customer AND the specified agent type. ATTENTION: Multiple executions of this script will add multiple notifications to each agent.
#>
